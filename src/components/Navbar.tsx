...
const archiveLinks = [
  ...
  {
    label: "The Plateau",
    href: "/archives/plateau",
    desc: "Modern Professional",
  },
  {
    label: "The Foothills",
    href: "/archives/foothills",
    desc: "Streetwear & Emerging",
  },
  {
    label: "Heritage Lab",
    href: "/archives/heritage",
    desc: "Textile History",
  },
];
...
const discoverLinks = [
  {
    label: "Designers",
    href: "/designers",
    desc: "Malawian brands & ateliers",
  },
  { label: "Models", href: "/models", desc: "Talent directory" },
  {
    label: "Consultancy",
    href: "/consultancy",
    desc: "Stylists & photographers",
  },
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  Archives
                  <ChevronDown
                    className={`w-3.5 h-3.5 transition-transform ${archivesOpen ? "rotate-180" : ""}`}
                  />
                </button>
                {archivesOpen && (
        ...
        <div className="fixed inset-0 z-[100] bg-background flex flex-col md:hidden animate-fade-up">
          <div className="flex items-center justify-between h-16 px-4">
            ...
            >
              ...
              />
              <span className="text-editorial-heading text-lg font-bold text-foreground">
                MOUNTAIN
              </span>
            </Link>
            <button
          ...
          <div className="flex flex-col items-center justify-start flex-1 gap-8 px-6 pt-12 pb-20 overflow-y-auto">
            ...
            <div className="flex flex-col items-center">
              ...
              >
                Archives
                <ChevronDown
                  className={`w-5 h-5 transition-transform ${mobileArchivesOpen ? "rotate-180" : ""}`}
                />
              </button>
              {mobileArchivesOpen && (
            ...
            <div className="flex flex-col items-center">
              ...
              >
                Discover
                <ChevronDown
                  className={`w-5 h-5 transition-transform ${mobileDiscoverOpen ? "rotate-180" : ""}`}
                />
              </button>
              {mobileDiscoverOpen && (
                <div className="flex flex-col items-center gap-3 mt-4">
